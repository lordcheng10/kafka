...
public class ConsumerGroupPartitionMetadataKey implements ApiMessage {
    String groupId;
    ...
    public ConsumerGroupPartitionMetadataKey(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public ConsumerGroupPartitionMetadataKey() {
        this.groupId = "";
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ConsumerGroupPartitionMetadataKey)) return false;
        ConsumerGroupPartitionMetadataKey other = (ConsumerGroupPartitionMetadataKey) obj;
    ...
    @Override
    public ConsumerGroupPartitionMetadataKey duplicate() {
        ConsumerGroupPartitionMetadataKey _duplicate = new ConsumerGroupPartitionMetadataKey();
    ...
    public String toString() {
        return "ConsumerGroupPartitionMetadataKey("
    ...
    public ConsumerGroupPartitionMetadataKey setGroupId(String v) {
        this.groupId = v;
        return this;
    }
}
