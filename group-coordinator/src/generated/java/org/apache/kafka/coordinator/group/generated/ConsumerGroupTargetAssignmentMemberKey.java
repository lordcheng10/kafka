...
public class ConsumerGroupTargetAssignmentMemberKey implements ApiMessage {
    String groupId;
    String memberId;
    ...
    public ConsumerGroupTargetAssignmentMemberKey(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public ConsumerGroupTargetAssignmentMemberKey() {
        this.groupId = "";
        this.memberId = "";
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ConsumerGroupTargetAssignmentMemberKey)) return false;
        ConsumerGroupTargetAssignmentMemberKey other = (ConsumerGroupTargetAssignmentMemberKey) obj;
    ...
    @Override
    public ConsumerGroupTargetAssignmentMemberKey duplicate() {
        ConsumerGroupTargetAssignmentMemberKey _duplicate = new ConsumerGroupTargetAssignmentMemberKey();
    ...
    public String toString() {
        return "ConsumerGroupTargetAssignmentMemberKey("
    ...
    public ConsumerGroupTargetAssignmentMemberKey setGroupId(String v) {
        this.groupId = v;
        return this;
    }
    
    public ConsumerGroupTargetAssignmentMemberKey setMemberId(String v) {
        this.memberId = v;
        return this;
    }
}
